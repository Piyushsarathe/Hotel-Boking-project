...
import CitycategorySchemamodel from '../models/Addcity.model.js';
export const save = async (req, res) => {
  //console.log("its");
  //var categoryDetail=req.body;
  // console.log(categoryDetail);
  var cList = await CitycategorySchemamodel.find();
  //console.log(cList);
  ...
  //console.log(caticon);
  var cityiconnm = rs.generate() + "-" + Date.now + "-" + caticon.name;
  var cDetails = { ...req.body, "cityiconnm": cityiconnm, "_id": _id };
  //console.log(cDetails);
  try {
    await CitycategorySchemamodel.create(cDetails);
    var _dirname = url.fileURLToPath(new URL(".", import.meta.url));
    var uploadpath = path.join(_dirname, "../../UI/public/assets/uploads/cityicon", cityiconnm);
...
export const fetch = async (req, res) => {
  var condition_obj = url.parse(req.url, true).query;
   //console.log(condition_obj);
  var cList = await CitycategorySchemamodel.find(condition_obj);
